...
import { MENU_MEGA } from '@/vendor/metronic/config/layout-1.config';
...
import { MegaMenuSubAccount } from '@/vendor/metronic/layouts/layout-1/shared/mega-menu/mega-menu-sub-account';
import { MegaMenuSubAuth } from '@/vendor/metronic/layouts/layout-1/shared/mega-menu/mega-menu-sub-auth';
import { MegaMenuSubNetwork } from '@/vendor/metronic/layouts/layout-1/shared/mega-menu/mega-menu-sub-network';
import { MegaMenuSubProfiles } from '@/vendor/metronic/layouts/layout-1/shared/mega-menu/mega-menu-sub-profiles';
import { MegaMenuSubStore } from '@/vendor/metronic/layouts/layout-1/shared/mega-menu/mega-menu-sub-store';
